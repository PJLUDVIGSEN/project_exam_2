  ...
  <nav className="header navbar navbar-expand-lg navbar-light">
      <div className="header container-fluid">
        ...
        <svg className="storeLogo" xmlns="http://www.w3.org/2000/svg" width="107.489" height="85.991" viewBox="0 0 107.489 85.991">
          ...
          <Link className="m-2 d-flex align-items-center" to="/browse">
            <svg xmlns="http://www.w3.org/2000/svg" width="18.955" height="15.743" viewBox="0 0 18.955 15.743">
              <g id="Group_38" data-name="Group 38" transform="translate(-388.328 -31.806)">
                <line id="Line_4" data-name="Line 4" x2="15.333" transform="translate(390.449 39.678)" fill="none" stroke="#333333" stroke-linecap="round" stroke-width="3"/>
                <path id="Path_23" data-name="Path 23" d="M0,5.75,5.75,0" transform="translate(390.449 33.928)" fill="none" stroke="#333333" stroke-linecap="round" stroke-width="3"/>
